export default function EmailIcon({ color }: { color: string }) {
  return (
    <svg width="30px" height="50px" viewBox="0 -2.5 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Dribbble-Light-Preview" transform="translate(-340.000000, -922.000000)" fill={color}>
